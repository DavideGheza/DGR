% Populating study   (from Katharina)          18-Jan-2017

% updated for Cue                                10/01/2018

clear all
eeglab
filepath = 'C:\Users\gdavide\Documents\MATLAB\dg_workspace16\Door gambling redos\splitted - Cue';
cd(filepath)
Files = dir('*.set'); 
Files = {Files.name}';
